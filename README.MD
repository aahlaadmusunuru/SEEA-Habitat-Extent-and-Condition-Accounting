...
Acknowledgement: For more information on the Habitat Extent and Conditions
Accounting Tool please contact Aahlaad Musunuru.
...
- [SEEA-Habitat Extent and Conditions Accounting-Tool](#seea-habitat-extent-and-conditions-accounting-tool)
  ...
  - [Overall Procedure:](#overall-procedure)
    ...
    - [Step-3: Generating Habitat Extent and Condition Accounts Using R-Shiny (Habitat Extent and Conditions Accounting-Tool):](#step-3-generating-habitat-extent-and-condition-accounts-using-r-shiny-habitat-extent-and-conditions-accounting-tool)
      - [Step-3.1.1 Step-1: R-Shiny (Habitat Extent and Condition Accounting)](#step-311-step-1-r-shiny-habitat-extent-and-condition-accounting)
      - [Step-3.1.2 R-Shiny Step-1 Upload Admin Boundaries(Habitat Extent and Condition Accounting)](#step-312-r-shiny-step-1-upload-admin-boundarieshabitat-extent-and-condition-accounting)
...
###  Step-3: Generating Habitat Extent and Condition Accounts Using R-Shiny (Habitat Extent and Conditions Accounting-Tool):
...
* Users can click on "INSTRUCTIONAL VIDEO" to see how  the  Habitat Extent and Conditions Accounting Tool works. 
  
* The below steps provide more elaborative way how to use the Habitat Extent and Condition Accounting tool.
  
#### Step-3.1.1 Step-1: R-Shiny (Habitat Extent and Condition Accounting)
...
![FirstStep](./Images/Habitate_extent_condition_Accounting_Tool.png)
<p style="text-align:center;text decoration:bold">Figure 18: Get-Started</p>

#### Step-3.1.2 R-Shiny Step-1 Upload Admin Boundaries(Habitat Extent and Condition Accounting)
